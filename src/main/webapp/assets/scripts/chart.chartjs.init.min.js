!function(e) {
	...
	e(document).ready(
			function() {
				return e("#bar-chartjs-chart").length
						&& t.bar("bar-chartjs-chart", "top", "bar"),
						e("#horizontal-bar-chartjs-chart").length
								&& t.bar("horizontal-bar-chartjs-chart",
										"right", "horizontalBar"),
						e("#line-chartjs-chart").length
								&& t.line("line-chartjs-chart", !1),
						e("#area-chartjs-chart").length
								&& t.line("area-chartjs-chart", !0),
						e("#pie-chartjs-chart").length
								&& t.pie("pie-chartjs-chart", "pie"),
						e("#donut-chartjs-chart").length
								&& t.pie("donut-chartjs-chart", "doughnut"),
						e("#polar-chartjs-chart").length
								&& t.polar("polar-chartjs-chart"),
						e("#radar-chartjs-chart").length
								&& t.radar("radar-chartjs-chart"), !1
			}), t = {
		bar : function(e, t, i) {
			var o = {
		...
		polar : function(e) {
			var t = document.getElementById(e).getContext("2d"), i = {
				data : {
					datasets : [ {
						data : [ r(), r(), r(), r() ],
						backgroundColor : [ "#f5707a", "#188ae2", "#4bd396",
								"#8d6e63" ],
						label : "My dataset"
					} ],
